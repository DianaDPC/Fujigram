    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('highlight_tone', models.IntegerField(default=0, validators=[django.core.validators.MinValueValidator(-2), django.core.validators.MaxValueValidator(2)])),
                ('shadow_tone', models.IntegerField(default=0, validators=[django.core.validators.MinValueValidator(-2), django.core.validators.MaxValueValidator(2)])),
                ...
                ('white_balance', models.CharField(choices=[('Custom', 'Custom'), ('Daylight', 'Daylight'), ('Shade', 'Shade'), ('Fluorescent Light 1', 'Fluorescent Light 1'), ('Fluorescent Light 2', 'Fluorescent Light 2'), ('Fluorescent Light 3', 'Fluorescent Light 3'), ('Incandescent', 'Incandescent'), ('Underwater', 'Underwater')], max_length=20)),
                ('white_balance_shift', models.IntegerField(default=0, validators=[django.core.validators.MinValueValidator(-9), django.core.validators.MaxValueValidator(9)])),
                ('color_saturation', models.IntegerField(default=0, validators=[django.core.validators.MinValueValidator(-4), django.core.validators.MaxValueValidator(4)])),
                ...
                ('iso', models.CharField(choices=[('Auto', 'Auto'), ('200', '200'), ('400', '400'), ('800', '800'), ('1600', '1600'), ('3200', '3200'), ('6400', '6400')], max_length=4)),
                ('exposure_compensation', models.IntegerField(default=0, validators=[django.core.validators.MinValueValidator(-5), django.core.validators.MaxValueValidator(5)])),
